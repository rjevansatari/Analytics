<?php
	...
	if ( $options['o'] ) { 
		...
		$output_file = "$CSV/app_figures_$type"."_day.csv";
	}

	$app_figures_request = "$CSV/app_figures_$type"."_request_$start_date.csv";
	...
	switch($type)a
	{
		...
		case "ranks":
		$url = "https://api.appfigures.com/v1.1/ranks/";
		break;

		case "reviews":
		$url = "https://api.appfigures.com/v1.1/reviews/";
		break;
