...
CREATE INDEX device_gen on staging.stage_session_day(device_gen(18));
...
count(distinct stat_date) as days_played
from star.s_user_day
group by 1,2,3
;

create index user on staging.s_user(game_id, client_id, user_id);
